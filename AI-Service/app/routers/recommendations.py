...
async def similar(movie_id: int, page: int = 1, type: str = "movie"):
    results = await engine.similar_movies(movie_id, page, type)
...
async def same_director(movie_id: int, page: int = 1, type: str = "movie"):
    results, director_name = await engine.by_same_director(movie_id, page, type, exclude_id=movie_id)
...
async def same_actor(movie_id: int, page: int = 1, type: str = "movie"):
    results, actor_name = await engine.by_same_actor(movie_id, page, type, exclude_id=movie_id)
...
async def same_genre(movie_id: int, page: int = 1, type: str = "movie"):
    results, genre_names = await engine.by_same_genre(movie_id, page, type, exclude_id=movie_id)
...
async def because_you_watched(movie_id: int, page: int = 1, type: str = "movie"):
    results, title = await engine.because_you_watched(movie_id, page, type)
